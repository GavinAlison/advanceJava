...
package com.alison.spring.beanCore;
...
public abstract class AbstractBeanFactory extends FactoryBeanRegistrySupport implements ConfigurableBeanFactory {
    ...
    protected <T> T doGetBean(String name, Class<T> requiredType, final Object[] args, boolean typeCheckOnly) throws BeansException {
        ...
        if (sharedInstance != null && args == null) {
            ...
            try {
                ...
                if (mbd.isSingleton()) {
                    // 获取单例, 提供一个ObjectFactory工厂对象的getObject方法进行获取对象,
                    // 第一步： getSingleton(beanName, ObjectFactory...)
    ...
    protected void destroyBean(String beanName, Object bean, RootBeanDefinition mbd) {
        // (new org.springframework.beans.factory.support.DisposableBeanAdapter(bean, beanName, mbd, this.getBeanPostProcessors(), this.getAccessControlContext())).destroy();
    }
    ...
    protected void registerCustomEditors(PropertyEditorRegistry registry) {
        ...
        if (!this.customEditors.isEmpty()) {
            ...
            while(var3.hasNext()) {
                Entry<Class<?>, Class<? extends PropertyEditor>> entry = (Entry)var3.next();
...
//                this.registerDisposableBean(beanName, new DisposableBeanAdapter(bean, beanName, mbd, this.getBeanPostProcessors(), acc));
                this.registerDisposableBean(beanName, null);
            } else {
...
//                scope.registerDestructionCallback(beanName, new DisposableBeanAdapter(bean, beanName, mbd, this.getBeanPostProcessors(), acc));
                scope.registerDestructionCallback(beanName, null);
            }
        }
