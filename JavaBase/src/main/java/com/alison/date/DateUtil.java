...
public class DateUtil {
     ...
     * @return
     */
    public static Date str2date(String dateStr, String format, String timeZone) {
     ...
     * @return
     */
    public static String date2str(Date date, String format, String timeZone) {
        if (date == null) {
            return null;
        }
        //1、格式化日期
     ...
     * @return
     */
    public static Date str2date_CTT(String dateStr, String format) {
        if (dateStr == null || format == null) {
            return null;
        }
        try {
    ...
    public static int getDiff(Date d1, Date d2, int calendarUnit) {
        ...
        switch (calendarUnit) {
            ...
            default: {
                throw new RuntimeException("[DateUtil.getDiff],Calendar Unit Not Support!");
            }
        }
     ...
     * @return
     */
    public static Long getDateNum(Date date) {
        if (date == null) {
            return null;
        }
