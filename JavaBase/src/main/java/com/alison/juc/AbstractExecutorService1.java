 ...
 * @author Doug Lea
 */
public abstract class AbstractExecutorService1 extends AbstractExecutorService {

    /**
     * Returns a {@code RunnableFuture} for the given runnable and default
     * value.
     * 根据参数runnable和value 值 创建一个RunnableFuture的对象，就是FutureTask对象
     *
    ...
    /**
     * 将task 封装成runnableFuture对象
     * 最终调用execute(ftask)方法
