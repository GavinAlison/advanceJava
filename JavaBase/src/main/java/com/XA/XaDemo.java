...
public class XaDemo {
    public static void main(String[] args) throws Exception {
        ...
        XAConnection accConn = new MysqlXAConnection((JDBC4Connection) accountConn, logXaCommands);
        ...
        XAConnection Conn2 = new MysqlXAConnection((JDBC4Connection) redConn, logXaCommands);
